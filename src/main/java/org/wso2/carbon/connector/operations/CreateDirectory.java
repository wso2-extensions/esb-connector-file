...
public class CreateDirectory extends AbstractConnector {
    ...
    public void connect(MessageContext messageContext) throws ConnectException {
        ...
        try {
            ...
            FileOperationResult result = new FileOperationResult("createDirectory",
                    true);
            ...
            FileConnectorUtils.setResultAsPayload(messageContext, result);
            handleException("Error while performing file:createDirectory for folder"
            ...
            if(folderToCreate != null) {
                try {
                    ...
                    log.error(FileConnectorConstants.CONNECTOR_NAME
                            + ":Error while closing file object while creating directory " + folderToCreate);
                }
            }
        }
    }
