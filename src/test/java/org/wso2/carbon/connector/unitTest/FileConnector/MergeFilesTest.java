...
import org.wso2.carbon.connector.MergeFiles;
...
public class  MergeFilesTest{
    ...
    /**
     * Test case for mergeFiles.
     */
    @Test
    public void testConnect(){
        TemplateContext templateContext = new TemplateContext("fileConnector", null);
        templateContext.getMappedValues().put("source", getFilePath("out/merge"));
        templateContext.getMappedValues().put("destination", getFilePath("out/merged.txt"));
