...
import org.wso2.carbon.connector.FileUnzip;

import java.nio.file.Paths;
import java.util.*;

/**
 * Unit test class for FileUnzip method
 */
public class FileUnzipUnitTest {

    private FileUnzip fileUnzip;
    ...
    public void testFileUnzip() throws Exception {
        ...
        templateContext.getMappedValues().put("destination", getFilePath("in/test"));
