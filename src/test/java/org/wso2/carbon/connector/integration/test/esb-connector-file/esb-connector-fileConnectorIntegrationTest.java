...
* under the License.
*/
package org.wso2.carbon.connector.integration.test.esb-connector-file;
 ...
 */
public class esb-connector-fileConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    @Test(enabled = true, groups = {"wso2.ei"}, description = "esb-connector-file test case")
